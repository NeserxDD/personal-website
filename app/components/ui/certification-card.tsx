...
export function CertificationCard({ cert }: CertificationCardProps) {
  ...
  return (
    <div className="group flex items-center gap-3 rounded-lg border border-gray-200 dark:border-gray-800 px-4 py-3 text-center transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/30">
      <img
        src={badgeImage}
        alt={name}
